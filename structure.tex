...
% Subsection text styling (note these are not shown by default, display them by searchings this file for tocdepth and reading the commented text)
...
\usepackage[colorlinks = true,linkcolor = orange,urlcolor = orange,citecolor = orange, anchorcolor = orange]{hyperref}
%\usepackage{bookmark}
...
%\hypersetup{backref=true,pagebackref=true,hyperindex=true,colorlinks=true,breaklinks=true,bookmarks=true,bookmarksopen=false}
\hypersetup{colorlinks=true,breaklinks=true,bookmarksopen=false}
...
{\;}% Punctuation after theorem head
{0.25em}% Space after theorem head
{\small\sffamily{\scriptscriptstyle\ensuremath{\blacksquare}}\nobreakspace\thmname{#1}\nobreakspace\thmnumber{\@ifnotempty{#1}{}\@upn{#2}}% Theorem text (e.g. Theorem 2.1)
...
\newenvironment{theorem}{\vspace{10pt}\begin{tBox}\begin{theoremeT}}{\end{theoremeT}\end{tBox}\vspace{10pt}}
\newenvironment{exercise}{\begin{eBox}\begin{exerciseT}}{\hfill{\color{ocre}\scriptscriptstyle\ensuremath{\blacksquare}}\end{exerciseT}\end{eBox}}
\newenvironment{definition}{\vspace{10pt}\begin{dBox}\begin{definitionT}}{\end{definitionT}\end{dBox}\vspace{10pt}}
\newenvironment{example}{\begin{exampleT}}{\hfill{\scriptscriptstyle\ensuremath{\blacksquare}}\end{exampleT}}
...
\definecolor{darkorange}{rgb}{0.95, 0.45, 0.0}
...
%\newcommandx{\tu}[2][1=]{\todo[linecolor=red,backgroundcolor=red!25,bordercolor=green,#1]{\textbf{Tanguy:} #2}}
%\newcommandx{\rol}[2][1=]{\todo[linecolor=purple,backgroundcolor=purple!25,bordercolor=green,#1]{\textbf{Romain:} #2}}
...
\newcommand{\requestable}{\textit{requestable}\xspace}
\newcommand{\informable}{\textit{informable}\xspace}

\usepackage[acronym,toc,symbols]{glossaries}
\usepackage{makeidx} % Required to make an index
\makeindex
\renewcommand*{\glstextformat}[1]{\textcolor{darkslateblue}{#1}}
\makeglossaries
...
% global change
%\SetKwData{KwData}{Input}
%\SetKwData{KwResult}{Output}
